...
```
[[附件/STM32/05617b320a34e2bc3906e9c07e025c0a_MD5.jpg|Open: Pasted image 20260922142253.png]]
![[附件/STM32/05617b320a34e2bc3906e9c07e025c0a_MD5.jpg|659]]
### 输入模式
...
按下：按键把引脚连接到GND，输入为0
```
[[附件/STM32/feb5f1b7642d0bd2f608ad56ee6c1ae1_MD5.jpg|Open: Pasted image20260922143048.png]]
![[附件/STM32/feb5f1b7642d0bd2f608ad56ee6c1ae1_MD5.jpg]]
...
$$
\Delta V=I\times R =1μA\times10kΩ =0.01V
$$
...
$$
[[附件/STM32/158f6fa1e780e0f932f2af71c563897d_MD5.jpg|Open: Pasted image 20260922162004.png]]
![[附件/STM32/158f6fa1e780e0f932f2af71c563897d_MD5.jpg]]
注意公式中都有 `+1`，因为从0开始计数。
例如ARR=9999时，CNT经历：
```
0, 1, 2, ... , 9999
...
换算公式：
$$
ADC值\approx\frac{V_{in}}{V_{REF}}\times4095
$$
反过来：
$$
V_{in}\approx\frac{ADC值}{4095}\times V_{REF}
$$
...
$$
\frac{3.3V}{4096}\approx0.000806V=0.806mV
$$
...
### 逐次逼近ADC
一般的单片机都是这个。
[[附件/STM32/e702ab9f6ca3cd0c6cabae1848c6e863_MD5.jpg|Open: Pasted image 20260922165542.png]]
![[附件/STM32/e702ab9f6ca3cd0c6cabae1848c6e863_MD5.jpg]]
...
STM32F103的转换时间：
$$
T_{CONV}=采样周期+12.5个ADC周期
$$
例如ADC时钟为14 MHz，采样时间为1.5周期：
$$
T=\frac{1.5+12.5}{14MHz}=1\mu s
$$
理论上每秒最多约转换100万次，但真实应用还要考虑触发、数据读取和通道切换。
[[附件/STM32/be286c55e9487a4dd92944a43a78ca1a_MD5.jpg|Open: Pasted image 20260922165442.png]]
![[附件/STM32/be286c55e9487a4dd92944a43a78ca1a_MD5.jpg]]
